...
var SAOPass = class _SAOPass extends Pass {
  ...
  render(renderer, writeBuffer, readBuffer) {
    ...
    this._renderPass(renderer, this.saoMaterial, this.saoRenderTarget, 16777215, 1);
    if (this.params.saoBlur) {
      this._renderPass(renderer, this.vBlurMaterial, this.blurIntermediateRenderTarget, 16777215, 1);
      this._renderPass(renderer, this.hBlurMaterial, this.saoRenderTarget, 16777215, 1);
    }
